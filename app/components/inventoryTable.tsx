...
export default function InventoryTable({ items }: InventoryTableProps) {
  return (
    <div className="p-6">
      ...
      {/* Table Structure */}
      <div className="overflow-x-wrap text-black">
        <table className="min-w-full table-auto border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="p-1 border border-gray-300 text-center">Name</th>
              <th className="p-1 border border-gray-300 text-center">Rarity</th>
              <th className="p-1 border border-gray-300 text-center">
                Description
              </th>
            </tr>
